...
/**
 * ManageGroupLink generated by hbm2java
 */
public class ManageGroupLink implements java.io.Serializable {
	...
	public ManageLink getManageLink() {
		return this.manageLink;
	}

	public void setManageLink(ManageLink manageLink) {
